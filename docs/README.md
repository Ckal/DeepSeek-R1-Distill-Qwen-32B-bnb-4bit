...
- URL: https://huggingface.co/spaces/Chris4K/DeepSeek-R1-Distill-Qwen-32B-bnb-4bit
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/DeepSeek-R1-Distill-Qwen-32B-bnb-4bit/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/DeepSeek-R1-Distill-Qwen-32B-bnb-4bit
